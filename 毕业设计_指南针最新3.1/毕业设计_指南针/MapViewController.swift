...
//        addressLabel.adjustsFontSizeToFitWidth = true
        ...
        getUserLocationBTn.frame = CGRect(x: 5, y: 20, width: deviceWidth * 0.1, height: deviceWidth * 0.1484)
//        getUserLocationBTn.setTitle("当前位置", forState: UIControlState.Normal)
//        getUserLocationBTn.setTitle("当前位置", forState: UIControlState.Highlighted)
//        getUserLocationBTn.setTitleColor(UIColor.whiteColor(), forState: UIControlState.Normal)
//        getUserLocationBTn.setTitleColor(UIColor(red: 110/255, green: 110/255, blue: 110/255, alpha: 1), forState: UIControlState.Highlighted)
        
        getUserLocationBTn.addTarget(self, action: "showCurrectLocation", forControlEvents: UIControlEvents.TouchUpInside)
        
        getUserLocationBTn.setImage(UIImage(named: "getmylocation"), forState: UIControlState.Normal)
        getUserLocationBTn.setImage(UIImage(named: "getmylocationheightlight"), forState: UIControlState.Highlighted)
...
//            getUserLocationBTn.titleLabel?.font = UIFont.systemFontOfSize(23.0)
...
//            getUserLocationBTn.titleLabel?.font = UIFont.systemFontOfSize(30.0)
        } else {
            longitudeLabel.font = UIFont.systemFontOfSize(17.0)
            latitudeLabel.font = UIFont.systemFontOfSize(17.0)
            addressLabel.font = UIFont.systemFontOfSize(20.0)
